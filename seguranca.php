...
$_SG['banco'] = 'dbturismo';       // Banco de dados MySQL
...
function validaUsuario($usuario,$senha) {
  ...
  $query = mysqli_query($_SG['link'],$sql); //conexão banco vaiavel 'link' mysqli
  $resultado = mysqli_fetch_assoc($query); //alterado acresentado $_SG['link']
